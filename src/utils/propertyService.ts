...
const getPackageIcon = (packageIdOrName: string) => {
  // Support both package ID and displayName for backward compatibility
  switch (packageIdOrName) {
    // Package IDs (language-independent)
    case 'google_drive':
    case 'Google Drive':
