    ...
    activityTemplates: [
      // ===== Kết nối =====
      {
        ...
        return: {
          displayName: 'Trạng thái kết nối',
          type: 'dictionary',
          description: 'Trạng thái kết nối và base URL',
        },
      },
      {
        templateId: 'erpnext.get_document',
        displayName: 'Lấy thông tin Document',
        description: 'Lấy chi tiết của một tài liệu cụ thể',
        iconCode: 'FaFileAlt',
        type: 'activity',
        ...
        arguments: {
          Doctype: {
            type: 'string',
            description: 'Loại tài liệu (ví dụ: Item, Customer)',
            keywordArg: 'doctype',
            value: '',
          },
          Name: {
      ...
      {
        templateId: 'erpnext.list_documents',
        displayName: 'Lấy danh sách Documents',
        description: 'Lấy danh sách tài liệu theo điều kiện lọc',
        iconCode: 'FaList',
        type: 'activity',
        ...
        arguments: {
          ...
          Filters: {
            type: 'dictionary',
            description: 'Bộ lọc (JSON hoặc Dict)',
            keywordArg: 'filters',
            value: {},
          },
          Fields: {
        ...
        return: {
          displayName: 'Danh sách tài liệu',
          type: 'list',
      ...
      // ===== Utility Methods =====
      {
        ...
        description: 'Cập nhật một tài liệu hiện có',
        iconCode: 'FaEdit',
        type: 'activity',
        ...
        return: {
          displayName: 'Tài liệu đã cập nhật',
          type: 'dictionary',
          description: 'Chi tiết tài liệu đã cập nhật',
        },
      },
      {
        templateId: 'erpnext.delete_document',
        displayName: 'Xóa Document',
        description: 'Xóa một tài liệu',
        iconCode: 'FaTrash',
        type: 'activity',
      ...
      {
        templateId: 'erpnext.ensure_company_exist',
        displayName: 'Đảm bảo Company tồn tại',
        description: 'Đảm bảo Công ty tồn tại, tạo mới nếu chưa có',
        iconCode: 'FaBuilding',
        type: 'activity',
      ...
      {
        templateId: 'erpnext.ensure_warehouse_exist',
        displayName: 'Đảm bảo Warehouse tồn tại',
        description: 'Đảm bảo Kho hàng tồn tại',
      ...
      {
        templateId: 'erpnext.ensure_supplier_exist',
        displayName: 'Đảm bảo Supplier tồn tại',
        description: 'Đảm bảo Nhà cung cấp tồn tại',
        iconCode: 'FaTruck',
        type: 'activity',
      ...
      {
        templateId: 'erpnext.ensure_items_exist',
        displayName: 'Đảm bảo Items tồn tại',
        description: 'Đảm bảo các mặt hàng tồn tại',
        iconCode: 'FaBox',
        type: 'activity',
        ...
        arguments: {
          Items: {
            type: 'list',
            description: 'Danh sách mặt hàng (item_code, description...)',
            keywordArg: 'items_json',
            value: [],
          },
        },
        return: {
          displayName: 'Các mặt hàng đã tạo',
          type: 'list',
          description: 'Danh sách mặt hàng đã tạo/tồn tại',
        },
      },
      {
        templateId: 'erpnext.ensure_customer_exist',
        displayName: 'Đảm bảo Customer tồn tại',
        description: 'Đảm bảo Khách hàng tồn tại',
        iconCode: 'FaUserTie',
        type: 'activity',
      ...
      // ===== Sales APIs =====
      {
        ...
        arguments: {
          ...
          Items: {
            type: 'list',
            description: 'Danh sách mặt hàng (item_code, qty, rate...)',
            keywordArg: 'items',
            value: [],
          },
          'Delivery Date': {
        ...
        return: {
          displayName: 'Đơn hàng bán',
          type: 'dictionary',
          description: 'Chi tiết đơn hàng bán',
        },
      },
      {
        templateId: 'erpnext.create_sales_invoice',
        displayName: 'Tạo Sales Invoice (Hóa đơn bán)',
        ...
        return: {
          displayName: 'Hóa đơn bán',
          type: 'dictionary',
          description: 'Chi tiết hóa đơn bán',
        },
      },
      {
        templateId: 'erpnext.create_stock_entry',
        displayName: 'Tạo Stock Entry (Kho)',
        description: 'Tạo phiếu nhập/xuất/chuyển kho',
        iconCode: 'FaDolly',
        type: 'activity',
        ...
        arguments: {
          Purpose: {
            type: 'string',
            description: 'Mục đích (Material Receipt, Material Issue...)',
            keywordArg: 'purpose',
            value: 'Material Receipt',
          },
          Items: {
            type: 'list',
            description: 'Danh sách mặt hàng với kho nguồn/đích',
            keywordArg: 'items',
            value: [],
          },
          Company: {
        ...
        return: {
          displayName: 'Phiếu kho',
          type: 'dictionary',
          description: 'Chi tiết phiếu kho',
        },
      },
      {
        templateId: 'erpnext.create_purchase_receipt',
        displayName: 'Tạo Purchase Receipt (Nhập mua)',
        description: 'Tạo phiếu nhập hàng mua',
        iconCode: 'FaReceipt',
        type: 'activity',
      ...
      // ===== Accounting APIs =====
      {
        ...
        description: 'Tạo hóa đơn mua hàng',
        iconCode: 'FaFileInvoiceDollar',
        type: 'activity',
        ...
        return: {
          displayName: 'Hóa đơn mua',
          type: 'dictionary',
          description: 'Chi tiết hóa đơn mua',
        },
      },
      {
        templateId: 'erpnext.create_payment_entry',
        displayName: 'Tạo Payment Entry (Thanh toán)',
        description: 'Tạo phiếu thanh toán',
        ...
        arguments: {
          'Payment Type': {
            type: 'string',
            description: 'Loại (Receive / Pay / Internal Transfer)',
        ...
        return: {
          displayName: 'Phiếu thanh toán',
          type: 'dictionary',
          description: 'Chi tiết phiếu thanh toán',
        },
      },
      {
        templateId: 'erpnext.load_excel_request',
        displayName: 'Đọc yêu cầu từ Excel',
      ...
      {
        templateId: 'erpnext.create_material_request_from_excel',
        displayName: 'Tạo Material Request từ Excel',
        description: 'Tạo Material Request sử dụng dữ liệu Excel đã đọc',
        ...
        return: {
          ...
          type: 'dictionary',
          description: 'Chi tiết Material Request',
        },
      },
      {
        templateId: 'erpnext.send_rfq_from_mr',
        displayName: 'Gửi RFQ từ Material Request',
        description: 'Tạo RFQ từ Material Request',
        ...
        arguments: {
          'Material Request Name': {
            type: 'string',
            description: 'ID Material Request',
            keywordArg: 'mr_name',
            value: '',
          },
          Suppliers: {
      ...
      {
        templateId: 'erpnext.receive_supplier_quotation',
        displayName: 'Nhận báo giá từ Supplier',
        description: 'Tạo Supplier Quotation từ RFQ',
        ...
        arguments: {
          ...
          'Quotation Data': {
            type: 'string',
            description: 'Đường dẫn file Excel hoặc List/JSON items',
        ...
        return: {
          ...
          type: 'dictionary',
          description: 'Chi tiết Supplier Quotation',
        },
      },
      {
        templateId: 'erpnext.create_purchase_order_from_quotation',
        displayName: 'Tạo Purchase Order từ báo giá',
        ...
        arguments: {
          'Quotation Name': {
            type: 'string',
            description: 'ID Supplier Quotation',
        ...
        return: {
          ...
          type: 'dictionary',
          description: 'Chi tiết Purchase Order',
        },
      },
    ],
  },
