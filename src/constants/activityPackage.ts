      ...
      activityTemplates: [
        // ===== Connection =====
        {
          ...
          return: {
            displayName: "Connection Status",
            type: "dictionary",
            description: "Connection status and base URL",
          },
        },
        {
          ...
          arguments: {
            Doctype: {
              type: "string",
              description: "Document Type (e.g. Item, Customer)",
              keywordArg: "doctype",
              value: "",
            },
            Name: {
        ...
        },
        {
          ...
          arguments: {
            ...
            Filters: {
              type: "dictionary",
              description: "Filters (JSON or Dict)",
              keywordArg: "filters",
              value: {},
            },
            Fields: {
        ...
        },
        {
          ...
          displayName: "Ensure Company Exist",
          description: "Ensure Company exists, create if not",
          iconCode: "FaBuilding",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Ensure Warehouse Exist",
          description: "Ensure Warehouse exists",
        ...
        },
        {
          ...
          displayName: "Ensure Supplier Exist",
          description: "Ensure Supplier exists",
          iconCode: "FaTruck",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Ensure Items Exist",
          description: "Ensure Items exist",
          iconCode: "FaBox",
          type: "activity",
          ...
          arguments: {
            Items: {
              type: "list",
              description: "List of items (item_code, description...)",
          ...
          return: {
            ...
            type: "list",
            description: "List of created/existing items",
          },
        },
        {
          templateId: "erpnext.ensure_customer_exist",
          displayName: "Ensure Customer Exist",
          description: "Ensure Customer exists",
          iconCode: "FaUserTie",
          type: "activity",
        ...
        // ===== Sales APIs =====
        {
          ...
          arguments: {
            ...
            Items: {
              type: "list",
              description: "List of items (item_code, qty, rate...)",
              keywordArg: "items",
              value: [],
            },
            "Delivery Date": {
        ...
        },
        {
          ...
          displayName: "Create Stock Entry",
          description: "Create Stock Entry (Material Receipt, Issue, Transfer)",
          iconCode: "FaDolly",
          type: "activity",
          ...
          arguments: {
            Purpose: {
              type: "string",
              description: "Material Receipt, Material Issue, etc.",
              keywordArg: "purpose",
              value: "Material Receipt",
            },
            Items: {
              type: "list",
              description: "Items with s_warehouse/t_warehouse",
              keywordArg: "items",
              value: [],
            },
            Company: {
        ...
        },
        {
          ...
          displayName: "Create Purchase Receipt",
        ...
        },
        {
          ...
          description: "Create Payment Entry",
          ...
          return: {
            ...
            type: "dictionary",
            description: "Payment Entry details",
          },
        },
        {
          templateId: "erpnext.load_excel_request",
          displayName: "Load Excel Request",
          description: "Load Excel file with company, itemcode, quantity",
        ...
        },
        {
          ...
          displayName: "Create Material Request From Excel",
          description: "Create Material Request using loaded Excel data",
        ...
        },
        {
          ...
          displayName: "Send RFQ From Material Request",
          description: "Create RFQ from Material Request",
        ...
        },
        {
          ...
          displayName: "Receive Supplier Quotation",
          description: "Create Supplier Quotation from RFQ",
          ...
          arguments: {
            ...
            "Quotation Data": {
              type: "string",
              description: "Excel file path or List/JSON of items",
          ...
          return: {
            ...
            type: "dictionary",
            description: "Supplier Quotation details",
          },
        },
        {
          templateId: "erpnext.create_purchase_order_from_quotation",
          displayName: "Create Purchase Order From Quotation",
          description: "Create Purchase Order from Supplier Quotation",
          ...
          arguments: {
            "Quotation Name": {
              type: "string",
              description: "Supplier Quotation ID",
