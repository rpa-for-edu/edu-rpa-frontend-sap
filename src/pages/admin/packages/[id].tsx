      ...
      <Container maxW="container.xl" py={5}>
        ...
        <Breadcrumb separator={<ChevronRightIcon color="gray.500" />} mb={6}>
          ...
          <BreadcrumbItem isCurrentPage>
            <BreadcrumbLink>{pkg.displayName}</BreadcrumbLink>
          </BreadcrumbItem>
        </Breadcrumb>

        <Flex justify="space-between" align="start" mb={6}>
          <VStack align="start" spacing={2}>
            <Heading size="lg" color={COLORS.primary}>{pkg.displayName}</Heading>
             <HStack spacing={4}>
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6} mb={8}>
          <Box p={5} shadow="sm" borderWidth="1px" borderRadius="lg" bg="white">
             ...
             <Text color="gray.600">{pkg.description || 'No description provided.'}</Text>
          </Box>
          <Box p={5} shadow="sm" borderWidth="1px" borderRadius="lg" bg="white">
